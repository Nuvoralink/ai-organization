...
description: "Use when polishing how UI FEELS: animation timing and easing decisions, spring physics, gesture and drag interactions, stagger choreography, component interaction details, and the invisible micro-details that make software feel great. Encodes Emil Kowalski's design-engineering philosophy. Trigger for 'should this animate', animation critique, motion debugging, or component-feel review — not for full-page visual design or layout generation (use design-taste-frontend or frontend-ui-engineering)."
---
