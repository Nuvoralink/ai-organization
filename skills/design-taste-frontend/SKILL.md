...
description: Anti-slop frontend skill for landing pages, portfolios, campaigns, and redesigns of public-facing marketing or editorial surfaces. The agent reads the brief, infers the right design direction, and ships interfaces that do not look templated. Not for dashboards, data tables, admin tools, or multi-step product UI. Real design systems when applicable, audit-first on redesigns, strict pre-flight check.
---
