...
The five-step process above is the controlling bundled methodology.
...
**Report fields**: original root cause; generalized pattern; exact search/query; files searched;
matches reviewed; true/false-positive classification; reachability; confidence; severity; and the
mutation that proves the search still catches the original class.
