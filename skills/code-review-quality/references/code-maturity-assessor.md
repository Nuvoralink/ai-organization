...
I assess 9 comprehensive categories covering all aspects of code maturity using the criteria and rating
logic in this file. No separate local criteria file is required.
...
Apply the quick-reference criteria above to every category and cite concrete repository evidence before
...
The required report contents are enumerated below; an external example is not required.
...
Use the report structure in this file.
