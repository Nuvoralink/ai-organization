...
- The configured control-plane path `${PROJECT:control-plane|backslash} Control Plane` was absent; the verified replacement root was `${PROJECT:control-plane|backslash}`, containing `control-plane.manifest.json`.
