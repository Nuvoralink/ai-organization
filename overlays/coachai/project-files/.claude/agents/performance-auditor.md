...
9. **Persistence and queue lifecycle** — sessions, jobs, reviews, transcript/analysis artifacts, AI usage, inbox/outbox, Redis keys, and queue terminal states name retention/compaction/terminalization and rebuild rules. Flag full-history recomputation and fanout rows that grow with readers instead of source facts.
