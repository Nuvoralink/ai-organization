---
name: specforge-dependency-supply-chain
description: Create dependency, license, SBOM, vulnerability scanning, provenance, artifact integrity, third-party risk, and patch cadence documentation.
---

# Dependency and Supply Chain Documentation
...
```text
Research current official software supply-chain, SBOM, SLSA, CycloneDX, SPDX, dependency review, vulnerability scanning, CI/CD, provenance, and artifact integrity guidance for [stack/package managers/CI/deployment]. Prefer official standards, OpenSSF, OWASP, NIST, and package manager docs. Record sources, versions/dates, and requirement IDs affected.
```
...
- Architecture
- CI/CD docs
- Existing repo evidence: package manifests, lockfiles, CI, release artifacts, dependency files

## Output files

Create or update:

- `docs/app-plan/engineering/24-dependency-supply-chain.md`
...
- New dependencies must require a reason, alternatives considered, risk review, license review, and removal plan.
- For existing repos, list evidence paths for package manifests and lockfiles.
- If no lockfile exists, flag it as a supply-chain risk unless the ecosystem has a justified alternative.
