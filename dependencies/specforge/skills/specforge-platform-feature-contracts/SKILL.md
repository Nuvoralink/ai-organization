---
name: specforge-platform-feature-contracts
description: Create platform and special-feature contracts for mobile, web, PWA, offline sync, notifications, email/SMS, uploads, payments, admin tools, search, webhooks, and integrations.
---

# Platform and Special-Feature Contracts
...
Force explicit decisions for platform-specific behavior and special features that often create hidden bugs, policy issues, security issues, or data leaks.
...
```text
Research current official docs for each selected platform and special feature: app stores, browser or PWA APIs, push notifications, email/SMS providers, payment providers, upload/storage providers, webhook/event standards, admin tooling, and offline sync patterns. Record source title, owner, version or date, URL, stable or draft status, document sections affected, and requirement IDs affected.
```
...
- `docs/app-plan/product/28-platform-feature-contracts.md`
